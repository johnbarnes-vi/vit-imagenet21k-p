...
def resize_image(inputFileName, output_size=224, input_str='imagenet1k', output_str='imagenet1k_resized'):
    try:
...
def main():
    path = '/mnt/imagenet1k/' # edit before use each time or parameterize this as a cmd-line argument
    import os
    ...
    pool = ThreadPool(8)
    resize_image_fun = partial(resize_image, input_str='imagenet1k', output_str='imagenet1k_resized')
